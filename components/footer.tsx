    ...
    <footer className="bg-neutral-50 border-t border-neutral-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="sm:col-span-2">
            <Link href="/" className="flex items-center space-x-3 mb-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm text-neutral-400 font-medium">{t("footer.tagline")}</span>
              </div>
            </Link>
            <p className="text-neutral-600 max-w-md">{t("footer.description")}</p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-neutral-900 mb-4">{t("footer.quickLinks")}</h3>
          ...
          {/* Solutions */}
          <div>
            <h3 className="font-semibold text-neutral-900 mb-4">{t("footer.solutions")}</h3>
            <ul className="space-y-2">
              <li>
                <span className="text-neutral-600">{t("footer.solutionList.boteco")}</span>
              </li>
              <li>
                <span className="text-neutral-600">{t("footer.solutionList.assistina")}</span>
              </li>
              <li>
                <span className="text-neutral-600">{t("footer.solutionList.custom")}</span>
              </li>
              <li>
                <span className="text-neutral-600">{t("footer.solutionList.integration")}</span>
              </li>
            </ul>
          </div>
          ...
          {/* Monynha Ecosystem */}
          <div>
            <h3 className="font-semibold text-neutral-900 mb-4">{t("footer.ecosystem")}</h3>
            <ul className="space-y-2">
              <li>
                <a
          ...
          {/* Contact */}
          <div>
            <h3 className="font-semibold text-neutral-900 mb-4">{t("footer.contact")}</h3>
            <ul className="space-y-2">
              ...
              <li className="text-sm text-muted-foreground">{t("footer.location")}: Faro, Portugal</li>
            </ul>
          </div>
        </div>
